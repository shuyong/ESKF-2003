 ...
 */
template <typename Scalar>
static inline void integrateFirst(Eigen::Quaternion<Scalar>& q, const Eigen::Matrix<Scalar,3,1>& w_hat, const Eigen::Matrix<Scalar,3,1>& w_bar, Scalar dt) {
  ...
  Eigen::Quaternion<Scalar> q_2nd(0, 0, 0, 0);
